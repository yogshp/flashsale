...
public class FlashSaleEvent {
	...
	public FlashSaleEvent(@NotNull String name, @NotNull Integer quantity, @NotNull LocalDateTime beginAt,
	...
	public String toString() {
		return "FlashSaleEvent [id=" + id + ", name=" + name + ", quantity=" + quantity + ", beginAt=" + beginAt
